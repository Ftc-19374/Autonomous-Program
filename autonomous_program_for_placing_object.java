...
@Autonomous(name = "park in warehouse after placing block")
public class autonomous_program_for_placing_object extends LinearOpMode {
    DcMotor motor;
    DcMotor frontLeft;
    DcMotor frontRight;
    DcMotor backLeft;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        waitForStart();
        chassis(-800,800,-800,800, 2);
        lift(1, 3);
        chassis(-500,-500, 500, 500, 2);
        claw(1);
        claw(-1);
        chassis(-1000,-1000,-1000,-1000, 2);
        chassis(-3500,3500,-3500,3500, 2);
    }
    ...
    public void lift(int upordown, int liftpoints) {
        ...
        runtime.reset();
        while (opModeIsActive() && (runtime.seconds() < 0.5*liftpoints)) {
            telemetry.addData("Path", "Leg 1: %2.5f S Elapsed", runtime.seconds());
            telemetry.update();
        }
        motor.setPower(0);
    }
    public void chassis(double fl, double fr, double bl, double br, int timeoutS) {
        int ntfl;
        int ntfr;
        int ntbl;
        int ntbr;
    ...
    public void claw(int openorclose){
        clawmotor.setPower(-1*(openorclose)*0.25);
        runtime.reset();
